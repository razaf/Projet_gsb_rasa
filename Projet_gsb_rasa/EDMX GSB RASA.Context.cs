...
namespace Projet_gsb_rasa
{
    ...
    public partial class GSB_Anjaka_SamuelEntities : DbContext
    {
        public GSB_Anjaka_SamuelEntities()
            : base("name=GSB_Anjaka_SamuelEntities")
        {
        }
        ...
        public virtual DbSet<lesFraisForfait> lesFraisForfait { get; set; }
    }
}
